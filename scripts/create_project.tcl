...
# Create project
create_project ${_xil_proj_name_} ./proj -part xc7a100tcsg324-1
...
# Add local files from the original project (-no_copy_sources specified)
set files [list \
 [file normalize "${origin_dir}/src/sources_1/ip/mig_7series_0/mig_7series_0.xci" ]\
]
set added_files [add_files -fileset sources_1 $files]
...
set file "[file normalize "$origin_dir/src/constrs_1/main.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "constrs_1/main.xdc"
